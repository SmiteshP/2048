...
bool board::next_left_possible() const {
    return (curr_board != next_left);
}

bool board::next_up_possible() const {
    return (curr_board != next_up);
}

bool board::next_right_possible() const {
    return (curr_board != next_right);
}

bool board::next_down_possible() const {
    return (curr_board != next_down);
}
